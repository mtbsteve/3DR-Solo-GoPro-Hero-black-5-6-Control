...
void setup()
{
  ...
  pinMode(10, OUTPUT); //bit 3 for sending Gopro Model
...
void whichGoproModel() {
  ...
  send_gopro_model_to_solo(gopro_model); // 0 if no valid Gopro detected
  //Serial.print("Gopro_model: ");
  //Serial.println(gopro_model);
}

void send_gopro_model_to_solo(int gopro_model) {
